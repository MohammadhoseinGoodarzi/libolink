...
export const MOCK_STORIES: Story[] = [
  { id: '1', coverUrl: 'https://picsum.photos/seed/story1/56/56', alt: 'Story 1' },
  { id: '2', coverUrl: 'https://picsum.photos/seed/story2/56/56', alt: 'Story 2' },
  { id: '3', coverUrl: 'https://picsum.photos/seed/story3/56/56', alt: 'Story 3' },
];
